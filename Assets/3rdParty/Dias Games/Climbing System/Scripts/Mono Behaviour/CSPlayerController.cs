...
namespace DiasGames.Controller
{
    public class CSPlayerController : MonoBehaviour
    {
        ...
        private void UpdateCharacterActions()
        {
            ...
            _scheduler.characterActions.slip = Slip;
            _scheduler.characterActions.bounce = Bounce;
        ...
        public void OnSlip(bool value){
            Slip = value;
        }
        public void OnBounce(bool value){
            Bounce = value;
        }
        ...
        {
            OnSlip(value.isPressed);
        }
        private void OnBounce(InputValue value)
        {
            OnBounce(value.isPressed);
        }
